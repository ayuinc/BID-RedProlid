...
class Profile_Builder_Form_Creator{
        ...
        if( $this->args['form_type'] == 'register' ){
            ...
            if ( !is_user_logged_in() ){
                ...
                if ( current_user_can( $current_user_capability ) && $registration )
                    ...
                    $this->wppb_form_content( apply_filters( 'wppb_register_pre_form_message', '<p class="alert" id="wppb_register_pre_form_message">'.__( '', 'profilebuilder').'</p>' ) );
	...
	function wppb_form_content( $message ){
		...
		<form enctype="multipart/form-data" method="post" id="<?php if( $this->args['form_type'] == 'register' ) echo 'wppb-register-user'; else if( $this->args['form_type'] == 'edit_profile' ) echo 'wppb-edit-user' ?>" class="wppb-user-forms" action="<?php echo apply_filters( 'wppb_form_action', '' ); ?>">
			...
			<p class="form-submit">
				...
				elseif( $this->args['form_type'] == 'edit_profile' )
					$button_name = __( 'Actualiza tu datos', 'profilebuilder' );
				?>			
	...
	function wppb_print_script(){
		if( $this->args['form_type'] == 'edit_profile' ){
			...
			$translation_array = array( 'avatar' => __( 'El avatar se ha eliminado correctamente!', 'profilebuilder' ), 'attachment' => __( 'El siguiente anexo se ha eliminado correctamente:', 'profilebuilder' ) );
