		...
		<?php
			...
			if (($show_type == 0) && ($i == 1) && ($options['password_meter'])) {
				...
				if ($input_name == ($prefix."PASSWORD2")) {
					...
					echo "\n\t\t<p class=\"description indicator-hint\">".__('Sugerencia: La contraseña debe tener al menos siete caracteres. Para hacerlo más fuerte, utilizar letras mayúsculas y minúsculas, números y símbolos como! ? "$% ^ & Amp;).')."</p><br />";
					$pass2_id = $unique_id;
				}
			}
