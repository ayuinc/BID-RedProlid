        ...
        <div class="container relative dtl-content">
         ...
         <!-- Start the Loop. -->
		          ...
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-right mr-21 img-circle relative ml-56" width="350px" height="auto">
		            ...
		            <h1 class="title-agenda-de-genero medium mt-21"><?php the_title(); ?></h1>
		            <!--<hr style="border-top: 3px dotted #aaa; width: 830px; margin-right: 178px;">-->
		          </div>
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-right mr-21 img-circle relative ml-56" width="350px" height="auto">
							<?php endif; ?>
		            ...
		            <h1 class="title-carrera-de-vallas medium mt-21"><?php the_title(); ?></h1>
		            <!--<hr style="border-top: 3px dotted #aaa; width: 830px; margin-right: 178px;">-->
		          </div>
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-right mr-21 img-circle relative ml-56" width="350px" height="auto">							
							<?php endif; ?>
		            ...
		            <h1 class="title-la-pinta-no-es-lo-de-menos medium mt-21"><?php the_title(); ?></h1>
		            <!--<hr style="border-top: 3px dotted #aaa; width: 830px; margin-right: 178px;">-->
		          </div>
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-right mr-21 img-circle relative ml-56" width="350px" height="auto">
							<?php endif; ?>
		            ...
		            <h1 class="title-listas-para-la-politica medium mt-21"><?php the_title(); ?></h1>
		            <!--<hr style="border-top: 3px dotted #aaa; width: 830px; margin-right: 178px;">-->
		          </div>
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-right mr-21 img-circle relative ml-56" width="350px" height="auto">
							<?php endif; ?>
		            ...
		            <h1 class="title-nivelando-la-cancha medium mt-21"><?php the_title(); ?></h1>
		          ...
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-left mr-21 img-circle relative pt-70 mt-42" width="350px" height="auto">
		            ...
		            <h1 class="title-pistas-2 medium mt-21"><?php the_title(); ?></h1>
		            <!--<hr style="border-top: 3px dotted #aaa; width: 830px; margin-right: 178px;">-->
		          </div>
		          <img src="<?php the_field('imagen-dtl-seccion'); ?>" alt="<?php the_title(); ?>" class="pull-right mr-21 img-circle relative ml-56" width="350px" height="auto">	
							<?php endif; ?>
