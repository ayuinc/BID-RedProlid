  ...
  <div class="container mt-7">
    ...
    <div class="ph-70">
	    ...
	    <div class="pv-21">
	    	...
	    	<?php if ($youtube!='') { ?>
	    		<iframe width="100%" height="551" src="//www.youtube.com/embed/<?php the_field('video_youtube'); ?>?rel=0&controls=0&showinfo=0" frameborder="0" allowfullscreen></iframe>     
				<?php } ?>
		    <?php $vimeo = get_field('video_video_vimeo'); ?>
	    	<?php if ($vimeo!='') { ?>			
					<iframe src="//player.vimeo.com/video/<?php the_field('video_video_vimeo'); ?>?color=1f3340&title=0&byline=0&portrait=0" width="100%" height="551" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				<?php } ?>
