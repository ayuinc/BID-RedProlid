	...
	<section class="bg-panel pv-21">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-4">
						<div class="form-group">
							<select name="lugar" id="" class="select-override form-control">
								...
								<option value="mexico-a-tu-estilo,mexico-d-f">México, México D.F.</option>
								<option value="mexico-a-tu-estilo,guadalajara">México, Guadalajara</option>
				...
				<div class="col-sm-8 bg-secondary p-0-sm p-7">
					<nav class="custom-nav">
						<input type="radio" name="tipo_lugar" value="restaurantes"> <label class="text-white">Restaurantes</label>
						<input type="radio" name="tipo_lugar" value="tiendas"> <label class="text-white">Tiendas</label>
