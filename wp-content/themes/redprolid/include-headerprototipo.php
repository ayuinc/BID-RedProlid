             ...
             <nav>
              <ul class="text-primary">
               ...
               <li class="bold text-gray pt-7">Forma parte de la Red PROLID</li>
                ...
                <li class="pv-7-xs">
                  <input placeholder="Nombre" class="border-radius  p-7" type="text" id="mce-FNAME" name="FNAME" style="height:42px">     
                </li>  
                <li class="hidden-xs hidden-sm"></li>
                <li class="pv-7-xs">
                  <input placeholder="Apellido" class="border-radius  p-7" type="text" id="mce-LNAME" name="LNAME" style="height:42px">     
                </li>   
                <li class="hidden-xs hidden-sm"></li>
                <li class="pv-7-xs">
                  <input placeholder="Correo Electrónico" name="EMAIL" class=" border-radius p-7 required email" type="text" id="mce-EMAIL" style="height:42px">            
                </li>
                <li style="position: absolute; left: -5000px;"><input type="text" name="b_242e37fe564525e1aad9cfc03_eb13f7ce93" tabindex="-1" value=""></div>
                <li class="hidden-xs hidden-sm"></li>                
                <li class="pv-14-xs text-center-xs text-left bold">
