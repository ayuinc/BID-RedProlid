    ...
    <div class="clearfix sub-header">
      ...
      <div class="col-sm-7 col-xs-12">
        <nav class="text-right text-center-xs">
          <a href="<?php echo home_url('/'); ?>video/videos-anteriores">Videos Anteriores</a> <span class="text-primary">|</span> <a href="<?php echo home_url('/'); ?>compartir-video">¿Quieres compartir un video?</a>
        </nav>	          
      </div>
    </div>
