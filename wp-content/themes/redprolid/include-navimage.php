          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a href="<?php echo home_url('/'); ?>desarrolla-tu-liderazgo/a-tu-estilo/">
                <img src="<?php echo content_url('/'); ?>uploads/2015/03/a-tu-estilo-rombo-bw.png" alt="" class="gs" style="height:142px !important">
                <img src="<?php echo content_url('/'); ?>uploads/2015/03/a-tu-estilo-rombo.png" alt="" class="color"  style="height:142px !important">
                <div class="title">                  
