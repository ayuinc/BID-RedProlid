...
get_header(); ?>
    ...
    <div class="mh-700">
	    <section class="mb-0 mt-7">
          ...
          <div class="mh-350 pb-21 mb-21 bg-img-control-right bg-img-control-top" style="background-image: url(<?php echo content_url('/'); ?>themes/redprolid/assets/img/red-prolid-network-right-half.png)">
