			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit orange-button"><?php _e( 'Submit', 'bbpress' ); ?></button>
