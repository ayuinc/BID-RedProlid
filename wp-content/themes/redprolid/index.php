        ...
        <div class="container pv-21">
          ...
          <div class="row hidden-md hidden-lg">
            ...
            <div class="col-xs-8 text-center pt-14">
              <a href="registrate"><button class="btn btn-primary">Regístrate en la Red</button></a> <a href="registrate"><button class="btn btn-primary mt-14-xs">Inicia Sesión</button></a>
            </div>
            <div class="col-xs-2"></div>
          </div>
        </div>
