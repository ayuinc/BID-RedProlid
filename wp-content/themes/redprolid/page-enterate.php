                    ...
                    <form class="form-search-inline" action="<?php echo home_url( '/' ); ?>" method="get">
											<div class="input-group">
											  ...
											  <span class="input-group-btn" style="display:block;right: -2px;">
											    <button type="submit" id="searchsubmit" class="btn btn-primary text-left"><p class="h3 light text-white mv-0" style="width: 106px !important ; background-position-x: 58px;">Buscar</p></button>
											  </span>
											</div><!-- /input-group -->
										</form>
                  </div>
