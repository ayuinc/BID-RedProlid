	...
	<?php if ( have_posts() ) : ?>
	    ...
	    <div class="container">
	      ...
	      <div class="clearfix sub-header">
	        <div class="icon-bienvenido col-lg-1 col-xs-12 col-sm-12 text-center-sm text-center-xs pt-35-xs">
	        ...
	        <div class="col-lg-11 col-xs-12 col-sm-12 text-center-sm text-center-xs">
			  ...
			  <div class="row pb-70">
			      ...
			      <div class="row">
				      ...
				      <div class="col-lg-5 col-sm-12 col-xs-12 hidden-sm hidden-xs hidden-md text-center-sm text-center-xs">
