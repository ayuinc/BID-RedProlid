			 		...
			 		<div class="col-md-8 col-sm-6 col-xs-12 ph-0-xs bg-white pv-70-md pr-0-md ph-70-md hidden-xs hidden-sm">
								<div class="col-md-12 col-sm-12 col-xs-12 text-left">
									...
									<div class="col-sm-12 col-xs-12 bg-white ph-0 pt-7 pb-42">
										...
										<p class="rem-10 mb-0">"La mujer se ha ido preparando...hay más mujeres con maestrías que hombres, hay más mujeres que están en la universidad que hombres..."</p>
										<a class="text-primary f-15 bold" href="<?php echo home_url('/'); ?>entrevista-a-erika-brockmann/">LEE MÁS  →</a>
									</div>
									<div class="video-center-content col-md-12 ph-0">
									...
									<div class="col-sm-12 col-xs-12 bg-white ph-0 pt-7 pb-42">
										...
										<p class="rem-10 mb-0">"Lo fundamental de la equidad de género es reconocer que los hombres y las mujeres tenemos distintas cosas que aportar y eso justamente es lo que hace necesario y valioso la participación de las mujeres..."</p>
										<a class="text-primary f-15 bold" href="<?php echo home_url('/'); ?>aida-garcia-naranjo-morales/">LEE MÁS  →</a>
									</div>		
									<div class="video-center-content col-md-12  ph-0">
									...
									<div class="col-sm-12 col-xs-12 bg-white ph-0 pt-7 pb-42">
										...
										<p class="rem-10  mb-0">"Lo primero que les diría (a las mujeres)...olvídense de la culpa porque no hay culpa asociada al proceso de querer ser mejor, de querer ser exitosa, de querer llegar más adelante"</p>
										<a class="text-primary f-15 bold" href="<?php echo home_url('/'); ?>lilian-soto/">LEE MÁS  →</a>
									</div>
				 					<div class="border-top-gray-light text-right ph-0 mv-35 col-md-12 col-sm-12">
