...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'https://localhost/' );
...
case 'retrievepassword' :
	...
	login_header(__('Lost Password'), '<p class="message">' . __('Por favor, escribe tu correo electrónico. Recibiras un enlace para crear una nueva contraseña por correo electrónico.') . '</p>', $errors);
...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
	...
	<p class="submit"><input type="submit" name="wp-submit" id="wp-submit" class="btn btn-primary" value="<?php esc_attr_e('Get New Password'); ?>" /></p>
</form>
...
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( site_url( 'wp-login.php?action=resetpass', 'login_post' ) ); ?>" method="post" autocomplete="off">
	...
	<p class="description indicator-hint"><?php _e('Sugerencia: La contraseña debe tener al menos siete caracteres. Para hacerlo más fuerte, use letras mayúsculas y minúsculas, números y símbolos como ! " ? $ % ^ &amp; ).'); ?></p>
